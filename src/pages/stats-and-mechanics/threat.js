  ...
  return (
    <MainLayout pageTitle="Threat Mechanics">
      <SideMenuLayout sideMenu={StatsAndMechanicsSideMenu}>
        ...
        <p>
          Threat is measurement which only purpose is to determine who will NPC attack in PvE encounter. This is decided
          using a <Link to="/stats-and-mechanics/threat/#when-will-npc-attack-a-player">set of specific conditions</Link>
          . Threat is generated by many effects in game and
          uses <Link to="/stats-and-mechanics/threat/#basic-threat-mechanics">set of specific Mechanics</Link> for
          Threath calculation.
        </p>
        ...
        <Heading2>When will NPC attack a player</Heading2>
        <ol>
